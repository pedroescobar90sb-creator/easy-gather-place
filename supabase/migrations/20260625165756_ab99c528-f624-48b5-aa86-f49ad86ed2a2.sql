...
do $$ begin create type app_role as enum ('admin','operacao'); exception when duplicate_object then null; end $$;
do $$ begin create type room_status as enum ('active','inactive','maintenance','blocked'); exception when duplicate_object then null; end $$;
do $$ begin create type room_type as enum ('suite','bangalo','standard','master'); exception when duplicate_object then null; end $$;
do $$ begin create type reservation_channel as enum ('direto','booking','whatsapp','telefone','site'); exception when duplicate_object then null; end $$;
do $$ begin create type reservation_status as enum ('pending','confirmed','checked_in','checked_out','cancelled','no_show'); exception when duplicate_object then null; end $$;
do $$ begin create type payment_status as enum ('pending','partial','paid','refunded'); exception when duplicate_object then null; end $$;
do $$ begin create type block_reason as enum ('maintenance','owner','blocked'); exception when duplicate_object then null; end $$;
