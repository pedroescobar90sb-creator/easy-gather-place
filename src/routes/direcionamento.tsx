...
function DirecionamentoPage() {
  return (
    <div
      className="relative min-h-screen overflow-hidden bg-cover bg-center bg-no-repeat flex flex-col"
    ...
    >
      ...
      <div className="relative flex-1 flex flex-col items-center justify-center px-6 py-16 text-center text-white">
        ...
        <img
          ...
          className="mt-8 h-40 sm:h-48 w-auto object-contain drop-shadow-[0_8px_30px_rgba(0,0,0,0.45)]"
        />

        <p className="mt-8 max-w-sm text-base sm:text-lg text-white/85 leading-relaxed">
          Cabines de madeira entre coqueiros, piscina iluminada até tarde e recepção
          dedicada — a 5 minutos do mar.
        </p>

        <div className="mt-9 flex w-full max-w-xs flex-col gap-4">
          <a
            href={WHATSAPP}
            target="_blank"
            rel="noopener"
          ...
          <Link
            to="/"
            className="inline-flex items-center justify-center gap-2 rounded-full border border-white/30 bg-white/10 backdrop-blur px-7 py-4 text-base font-semibold text-white transition hover:bg-white/15"
          >
            Conheça a Pousada
        ...
        <p className="mt-8 text-xs uppercase tracking-[0.24em] text-white/70">
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-white/85 hover:text-white transition"
        >
