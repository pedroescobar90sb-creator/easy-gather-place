...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Gerencie sua pousada com um sistema web premium para reservas diretas, controle de 13 quartos e prevenção de overbooking." },
      { property: "og:title", content: "Lovable App" },
      { name: "twitter:title", content: "Lovable App" },
      { property: "og:description", content: "Gerencie sua pousada com um sistema web premium para reservas diretas, controle de 13 quartos e prevenção de overbooking." },
      { name: "twitter:description", content: "Gerencie sua pousada com um sistema web premium para reservas diretas, controle de 13 quartos e prevenção de overbooking." },
